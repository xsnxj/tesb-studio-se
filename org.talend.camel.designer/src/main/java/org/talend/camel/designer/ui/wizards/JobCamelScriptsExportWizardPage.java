 ...
 * 
 */
public abstract class JobCamelScriptsExportWizardPage extends WizardFileSystemResourceExportPage1 {
...
//    private String outputFileSuffix = ".zip"; //$NON-NLS-1$
    ...
    private boolean exportJobScript(String version, IProgressMonitor monitor) {
        ...
        try {
            ...
            boolean hasErrors = CorePlugin.getDefault().getRunProcessService().checkExportProcess(selection, false);
            if (hasErrors) {
