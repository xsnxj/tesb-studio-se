...
public class ServiceOperationImpl extends AbstractMetadataObjectImpl implements ServiceOperation {
    ...
    /**
     * The default value of the '{@link #getReferenceJobId() <em>Reference Job Id</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getReferenceJobId() <em>Reference Job Id</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getReferenceJobId()
     * @generated
    ...
    /**
     * The default value of the '{@link #getOperationName() <em>Operation Name</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getOperationName() <em>Operation Name</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getOperationName()
     * @generated
    ...
    /**
     * The default value of the '{@link #getOperationLabel() <em>Operation Label</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getOperationLabel() <em>Operation Label</em>}' attribute. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getOperationLabel()
     * @generated
    ...
    public void setReferenceJobId(String newReferenceJobId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_OPERATION__REFERENCE_JOB_ID,
                    oldReferenceJobId, referenceJobId));
    }
    ...
    public void setOperationName(String newOperationName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_OPERATION__OPERATION_NAME,
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_OPERATION__DOCUMENTATION,
    ...
    public void setOperationLabel(String newOperationLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ServicesPackage.SERVICE_OPERATION__OPERATION_LABEL,
                    oldOperationLabel, operationLabel));
    }
