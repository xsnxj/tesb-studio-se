...
public final class RouteMapping {
    ...
    static {
        ...
        connectionStyleMap.put(ICamelSpringConstants.ROUTE, EConnectionType.ROUTE);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_CATCH, EConnectionType.ROUTE_CATCH);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_ENDBLOCK, EConnectionType.ROUTE_ENDBLOCK);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_FINALLY, EConnectionType.ROUTE_FINALLY);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_OTHER, EConnectionType.ROUTE_OTHER);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_WHEN, EConnectionType.ROUTE_WHEN);
        connectionStyleMap.put(ICamelSpringConstants.ROUTE_TRY, EConnectionType.ROUTE_TRY);

        componentNameMap.put(ICamelSpringConstants.ACTIVEMQ, "cActiveMQ");
        ...
        componentNameMap.put(ICamelSpringConstants.MSGENDPOINT, "cMessagingEndpoint");
        ...
        componentNameMap.put(ICamelSpringConstants.UNKNOWN, "cMessagingEndpoint");

        COMPOMENT_NAMES[ICamelSpringConstants.ACTIVEMQ] = "cActiveMQ";
