 ...
 */
public class CActiveMQParameterHandler extends AbstractParameterHandler {

    public CActiveMQParameterHandler(String componentName) {
        super(componentName);
    }
    ...
    public Map<String, List<String>> getTableParameters() {
        ...
        columns.add("NAME");
        columns.add("VALUE");
        tableParams.put("URI_OPTIONS", columns);
