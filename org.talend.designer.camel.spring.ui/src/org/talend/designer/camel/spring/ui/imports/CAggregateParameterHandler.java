...
public class CAggregateParameterHandler extends AbstractParameterHandler {
    ...
    public void handle(NodeType nodeType, String uniqueName, Map<String, String> parameters) {
        ...
        addParamType(nodeType.getElementParameter(), FIELD_CHECK, "USE_PERSISTENCE", USE_PERSISTENCE);
        addParamType(nodeType.getElementParameter(), FIELD_CLOSED_LIST, "REPOSITORY", REPOSITORY_TYPE);
        ...
        addParamType(nodeType.getElementParameter(), FIELD_CHECK, "DEAD_LETTER_URI", DEAD_LETTER_CHANNEL);
        addParamType(nodeType.getElementParameter(), FIELD_CHECK, "RECOVERY_INTERVAL", RECOVER_INTERVAL);
