...
public class GridLayoutManager {
    ...
    private static final GridLayoutManager instance = new GridLayoutManager();
    ...
    public Point getNextPosition(String componentId, String parentId) {
        ...
        LayoutNode node = new LayoutNode(componentId);
        node.setDelta(delta);
        node.setPosition(parent.getNextChildPosition(0).getCopy());
        caches.put(componentId, node);
     ...
     * @return the instance
     */
    public static GridLayoutManager getInstance() {
        return instance;
    }
}
