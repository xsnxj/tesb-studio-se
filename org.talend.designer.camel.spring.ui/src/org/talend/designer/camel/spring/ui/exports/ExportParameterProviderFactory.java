...
public class ExportParameterProviderFactory {
    ...
    private void init() {
        ...
        exportHandlers.put(componentName, new CContentEnricherExParameterHandler(componentName));

        componentName = RouteMapping.COMPOMENT_NAMES[ICamelSpringConstants.EXCEPTION];
        exportHandlers.put(componentName, new COnExceptionExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CIdempotentConsumerExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CLoopExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CMutilcastExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CPipesAndFiltersExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CSetHeaderExParameterHandler(componentName));
        ...
        exportHandlers.put(componentName, new CWiredTapExParameterHandler(componentName));
        
        componentName = RouteMapping.COMPOMENT_NAMES[ICamelSpringConstants.WHEN];
        exportHandlers.put(componentName, new CWhenExParameterHandler(componentName));
        
        componentName = RouteMapping.COMPOMENT_NAMES[ICamelSpringConstants.OTHER];
        exportHandlers.put(componentName, new COtherExParameterHandler(componentName));
        
        componentName = RouteMapping.COMPOMENT_NAMES[ICamelSpringConstants.CATCH];
        exportHandlers.put(componentName, new CCatchExParameterHandler(componentName));
