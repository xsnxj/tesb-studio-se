 ...
 * @author GaoZone (modify from {@link org.eclipse.pde.internal.ui.parts.PluginVersionPart}}
 * 
 * 
 */
public class DependencyVersionPart {
	...
	/**
	 * Instantiates a new dependency version part.
	 * Support single version input and version range input.
	 * @param rangeAllowed the range allowed, true means need to fill both min version and max version.
	 */
	 ...
	 *
	 * @param comp the comp
	 * @param createGroup the create group
	...
	private void createRangeField(Composite parent, boolean createGroup,
		...
		String[] comboItems = new String[] {Messages.DependencyVersionPart_comboInclusive, Messages.DependencyVersionPart_comboExclusive};
	...
	private IStatus validateVersionRange( ) {
		...
		return new Status(IStatus.ERROR, UIActivator.PLUGIN_ID,  
				IStatus.ERROR, Messages.DependencyVersionDialog_versionRangeError, null);
	}
	 ...
	 * Adds the listeners.
	 *
	 * @param minListener the min listener
	 * @param selectionListener the selection listener
	 */
	public void addListeners(ModifyListener minListener, SelectionListener selectionListener) {
