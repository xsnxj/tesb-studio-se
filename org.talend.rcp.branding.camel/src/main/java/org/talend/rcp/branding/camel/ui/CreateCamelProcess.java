...
import org.talend.rcp.branding.camel.ui.wizards.CamelNewProcessWizard;
 ...
 * 
 */
public class CreateCamelProcess extends AContextualAction implements IIntroAction {
    ...
    public IRepositoryNode getProcessNode() {
        ...
        for (IRepositoryNode repositoryNode : chindren) {
            if (((RepositoryNode) repositoryNode).getContentType() == ERepositoryObjectType.ROUTES) {
    ...
    public void init(TreeViewer viewer, IStructuredSelection selection) {
        ...
        if (canWork) {
            ...
            case SYSTEM_FOLDER:
                ...
                if (nodeType != ERepositoryObjectType.ROUTES) {
                    canWork = false;
                }
