...
//
// ============================================================================
package org.talend.rcp.branding.camel.ui.bean;
...
import org.talend.rcp.branding.camel.ui.wizards.CamelNewBeanWizard;
...
public class CreateCamelBean extends AbstractBeanAction implements IIntroAction {
    ...
    public void init(TreeViewer viewer, IStructuredSelection selection) {
        ...
        if (canWork) {
            ...
            case SYSTEM_FOLDER:
                ...
                if (nodeType != ERepositoryObjectType.BEANS) {
                    canWork = false;
                }
    ...
    protected void doRun() {
        ...
        if (isToolbar()) {
            if (beanNode != null && beanNode.getContentType() != ERepositoryObjectType.BEANS) {
                beanNode = null;
            }
            if (beanNode == null) {
                beanNode = getRepositoryNodeForDefault(ERepositoryObjectType.BEANS);
            }
        }
        ...
        if (dlg.open() == Window.OK) {
            RepositoryManager.refreshCreatedNode(ERepositoryObjectType.BEANS);
    ...
    private void selectRootObject(Properties params) {
        try {
            ...
            if (ERepositoryObjectType.BEANS.name().equals(type)) {
