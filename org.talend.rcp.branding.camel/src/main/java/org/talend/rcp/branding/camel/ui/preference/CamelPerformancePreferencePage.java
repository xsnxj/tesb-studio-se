...
//
// ============================================================================
package org.talend.rcp.branding.camel.ui.preference;
...
public class CamelPerformancePreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

    private CheckBoxFieldEditor dbConnTimeoutActive;

    private IntegerFieldEditor dbConnTimeout;

    public CamelPerformancePreferencePage() {
        super(GRID);
