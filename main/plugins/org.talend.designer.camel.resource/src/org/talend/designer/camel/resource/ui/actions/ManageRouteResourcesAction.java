...
public class ManageRouteResourcesAction extends AContextualAction {
	...
	public ManageRouteResourcesAction() {
		...
		this.setImageDescriptor(RouteResourceActivator
				.createImageDesc("icons/manage-route-resource.png"));
	}

	/**
	 * if readonly, then it's uneditable
	 * else lock it first, and after that unlock if no any
	 * other editor is openning.
	 */
