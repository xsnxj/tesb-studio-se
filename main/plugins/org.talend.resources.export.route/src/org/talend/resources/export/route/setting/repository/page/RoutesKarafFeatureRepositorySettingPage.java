...
import org.talend.resources.export.route.setting.project.RoutesKarafFeatureProjectSettingPage;

/**
 * DOC ggu class global comment. Detailled comment
 */
public class RoutesKarafFeatureRepositorySettingPage extends RoutesKarafFeatureProjectSettingPage {

    private IFile scriptFile;

    public RoutesKarafFeatureRepositorySettingPage(IFile scriptFile) {
        super();
