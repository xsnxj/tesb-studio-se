 ...
 */
public class ServicesKarafPomProjectSettingPage extends AbstractKarafMavenScriptProjectSettingPage {
    ...
    protected String getPreferenceKey() {
        return IProjectSettingPreferenceConstants.TEMPLATE_SERVICES_KARAF_POM;
    }
    ...
    protected String getHeadTitle() {
        return Messages.getString("ServicesKarafPomProjectSettingPage_Title"); //$NON-NLS-1$
    }
