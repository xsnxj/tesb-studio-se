...
//
// ============================================================================
package org.talend.resources.export.i18n;
...
public class Messages extends MessagesCore {
    ...
    public static String getString(String key) {
        return getString(key, ExportRouteResourcesPlugin.PLUGIN_ID, resourceBundle);
    }
    ...
    public static String getString(String key, Object... args) {
        return MessagesCore.getString(key, ExportRouteResourcesPlugin.PLUGIN_ID, resourceBundle, args);
    }
}
