...
import org.talend.resources.export.route.setting.project.RoutesKarafPomProjectSettingPage;

/**
 * DOC ggu class global comment. Detailled comment
 */
public class RoutesKarafPomRepositorySettingPage extends RoutesKarafPomProjectSettingPage {

    private IFile scriptFile;

    public RoutesKarafPomRepositorySettingPage(IFile scriptFile) {
        super();
