 ...
 */
public class RoutesKarafParentProjectSettingPage extends AbstractKarafMavenScriptProjectSettingPage {
    ...
    protected String getPreferenceKey() {
        return IProjectSettingPreferenceConstants.TEMPLATE_ROUTES_KARAF_PARENT;
    }
    ...
    protected String getHeadTitle() {
        return Messages.getString("RoutesKarafParentProjectSettingPage_Title"); //$NON-NLS-1$
    }
