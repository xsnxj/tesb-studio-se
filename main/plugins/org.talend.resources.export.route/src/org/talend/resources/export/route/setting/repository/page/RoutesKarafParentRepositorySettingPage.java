...
import org.talend.resources.export.route.setting.project.RoutesKarafParentProjectSettingPage;

/**
 * DOC ggu class global comment. Detailled comment
 */
public class RoutesKarafParentRepositorySettingPage extends RoutesKarafParentProjectSettingPage {

    private IFile scriptFile;

    public RoutesKarafParentRepositorySettingPage(IFile scriptFile) {
        super();
