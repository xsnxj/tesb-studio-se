 ...
 */
public class ServicesKarafBundleProjectSettingPage extends AbstractKarafMavenScriptProjectSettingPage {
    ...
    protected String getPreferenceKey() {
        return IProjectSettingPreferenceConstants.TEMPLATE_SERVICES_KARAF_BUNDLE;
    }
    ...
    protected String getHeadTitle() {
        return Messages.getString("ServicesKarafBundleProjectSettingPage_Title"); //$NON-NLS-1$
    }
