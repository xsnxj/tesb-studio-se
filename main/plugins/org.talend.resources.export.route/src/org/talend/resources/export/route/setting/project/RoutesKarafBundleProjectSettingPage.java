 ...
 */
public class RoutesKarafBundleProjectSettingPage extends AbstractKarafMavenScriptProjectSettingPage {
    ...
    protected String getPreferenceKey() {
        return IProjectSettingPreferenceConstants.TEMPLATE_ROUTES_KARAF_BUNDLE;
    }
    ...
    protected String getHeadTitle() {
        return Messages.getString("RoutesKarafBundleProjectSettingPage_Title"); //$NON-NLS-1$
    }
