 ...
 */
public class RouteResourceNodeTester extends AbstractNodeTester {

	private static final String IS_ROUTE_RESOURCE_NODE = "isRouteResourceNode"; //$NON-NLS-1$
    ...
    protected Boolean testProperty(Object receiver, String property, Object[] args, Object expectedValue) {
        if (receiver instanceof RepositoryNode) {
			...
			if (IS_ROUTE_RESOURCE_NODE.equals(property)) {
				return isRouteResourceNode(repositoryNode);
            }
        }
        return null;
    }
