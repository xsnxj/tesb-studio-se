...
public class EsbPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		IntegerFieldEditor localWebServiceHttpPort = new IntegerFieldEditor(
				WebServiceComponentPlugin.WS_HTTP_PORT_PREFERENCE,
				Messages.getString("esb.preferences.webservice.port.default"),
